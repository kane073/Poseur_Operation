...
function Grillage(idDiv) {
    ...
    canvasOutil.onmousedown = function(event) {
        var positionSourcis = getSourisPositionMenuOutils(event);
        var positionBontton = getCoordonneButtonOutils(positionSourcis.x, positionSourcis.y);
    ...
    function dessineContour(x, y, couleur) {
        ...
        contextCanvasGrille.lineWidth = 1;
        //Début de la tracé
